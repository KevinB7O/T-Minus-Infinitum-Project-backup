 	...
 	private void nextLevel() {
		...
		private void spawnWave(int wave) {
	 	    ...
	 	    if (wave == 1) {
	 	        ...
	 	        for (Enemyship4 enemy : wave2Enemies) {
	 	            GPolygon enemyVisual = enemy.getVisual();
	 	            enemyVisuals.add(enemyVisual);
	 	            add(enemyVisual);
	 	        }
